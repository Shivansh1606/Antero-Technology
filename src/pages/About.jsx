      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-teal-600">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a 
              href="/contact" 
              className="bg-white text-green-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl"
            >
              Get Started Today
            </a>
            <a 
              href="tel:+919876543210" 
              className="border-2 border-white bg-white/10 backdrop-blur-sm text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-green-600 transition-all shadow-2xl"
            >
              📞 Call Now
            </a>
          </div>
